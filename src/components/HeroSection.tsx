...
const HeroSection = () => {
  ...
  useEffect(() => {
    ...
    const links: [number, number][] = [
      // Brasil interno
      [0, 1], [0, 4], [0, 5], [0, 7], [5, 1], [4, 6], [7, 5], [1, 5],
      // América do Sul
      [0, 2], [6, 8], [2, 9], [0, 6], [4, 8], [2, 8],
      // LATAM norte
      [9, 10], [10, 11], [11, 12], [12, 3], [9, 12],
      // América do Norte
      [3, 13], [3, 11], [12, 13], [11, 13],
      // Transatlântico (Americas ↔ Europa)
      [3, 14], [13, 14], [3, 15], [12, 18], [13, 17],
      // América do Sul ↔ África
      [0, 24], [1, 24], [0, 22],
      // Europa interna
      [14, 16], [14, 17], [15, 16], [15, 19], [16, 18], [17, 21],
      [18, 19], [19, 20], [20, 15], [21, 20], [14, 18], [17, 20], [16, 19],
      // Europa ↔ África
      [18, 24], [14, 24], [18, 26], [19, 26], [16, 24],
      // África interna
      [24, 25], [22, 23], [22, 24], [25, 22], [24, 26], [23, 22], [25, 26],
      // Europa ↔ Oriente Médio
      [19, 29], [15, 27], [26, 27], [26, 29], [20, 29], [19, 28],
      // Oriente Médio interno
      [27, 28], [28, 29], [27, 29],
      // Oriente Médio ↔ Ásia
      [27, 30], [30, 32], [28, 30], [29, 30],
      // Ásia interna
      [30, 31], [31, 32], [32, 33], [30, 33],
      // África ↔ Ásia
      [25, 30], [22, 33], [25, 32],
      // Ásia ↔ Oceania
      [31, 33],
